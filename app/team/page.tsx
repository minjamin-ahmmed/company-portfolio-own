...
import { ArrowRight, Linkedin, Twitter, Github, Mail, MapPin } from "lucide-react"
...
const teamMembers = [
  {
    ...
    skills: ["Strategic Planning", "Product Vision", "Team Leadership", "Fundraising"],
    ...
    achievements: ["Forbes 30 Under 30", "TechCrunch Disruptor Award", "Y Combinator Alum"],
  },
  {
    id: 2,
    ...
    skills: ["System Architecture", "Cloud Infrastructure", "Team Management", "DevOps"],
    location: "Austin, TX",
    social: {
      linkedin: "#",
      github: "#",
    ...
    achievements: ["Google Cloud Certified", "AWS Solutions Architect", "Open Source Contributor"],
  },
  {
    id: 3,
    name: "Emily Watson",
    ...
    achievements: ["Webby Award Winner", "Design Systems Expert", "Adobe Creative Resident"],
  },
  {
    id: 4,
    name: "David Kim",
    ...
    achievements: ["React Contributor", "Tech Conference Speaker", "Hackathon Winner"],
  },
  {
    id: 5,
    name: "Priya Patel",
    ...
    skills: ["Product Strategy", "Data Analysis", "User Research", "Agile Methodology"],
    location: "Boston, MA",
    social: {
      linkedin: "#",
      twitter: "#",
    ...
    achievements: ["Product Management Certified", "Growth Hacking Expert", "Analytics Specialist"],
  },
  {
    id: 6,
    name: "Alex Thompson",
    ...
    achievements: ["Kubernetes Certified", "Security Expert", "Infrastructure Automation"],
  },
  {
    id: 7,
    name: "Lisa Zhang",
    ...
    skills: ["Interface Design", "User Testing", "Figma", "Animation", "Accessibility"],
    ...
    achievements: ["Design Award Winner", "Accessibility Advocate", "Design Mentor"],
  },
  {
    id: 8,
    name: "James Wilson",
    ...
    achievements: ["App Store Featured", "Mobile Expert", "Performance Optimization"],
  },
]
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative py-20 lg:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(120,119,198,0.1),transparent_50%)] dark:bg-[radial-gradient(circle_at_80%_20%,rgba(251,146,60,0.1),transparent_50%)]" />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              We're a diverse team of passionate professionals from around the world, united by our commitment to
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-balance mb-6">Our Culture</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Unlimited PTO, mental health support, and respect for personal time.",
                icon: "⚖️",
              },
            ].map((value, index) => (
              <motion.div
      ...
      <section className="py-20 bg-primary/5">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-balance mb-6">Join Our Team</h2>
